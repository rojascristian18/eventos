                    ...
                    <div class="tab-pane active" id="evento">
                    	...
                    	<div class="form-group">
	                   	...
	                   	<div class="form-group">
	                    	<div class="col-xs-12 col-sm-4">
	                    		<? if (!empty($this->request->data['Evento']['logo'])) : ?>
	                    		<div class="col-xs-12 col-sm-6">
	                    			<label><?= $this->Form->label('logo', 'Logo del evento actual'); ?></label>
									<?= $this->Html->image($this->request->data['Evento']['logo']['mini'], array('class' => 'img-responsive')); ?>
	                    		</div>
	                    		<div class="col-xs-12 col-sm-6">
	                    	...
	                    	<div class="col-xs-12 col-sm-4">
	                    		<? if (!empty($this->request->data['Evento']['favicon'])) : ?>
	                    		<div class="col-xs-12 col-sm-6">
	                    			<label><?= $this->Form->label('favicon', 'Favicon del evento actual'); ?></label>
									<?= $this->Html->image($this->request->data['Evento']['favicon']['mini'], array('class' => 'img-responsive')); ?>
	                    		</div>
	                    		<div class="col-xs-12 col-sm-6">
	                    ...
	                    <div class="form-group">
	                    	<div class="col-xs-12 col-sm-6">
	                    		...
	                    		<? if (!empty($this->request->data['Evento']['imagen_inactivo'])) : ?>
	                    		<div class="col-xs-12 col-sm-6">
	                    			<label><?= $this->Form->label('imagen_inactivo', 'Imagen para la inactividad del evento actual'); ?></label>
									<?= $this->Html->image($this->request->data['Evento']['imagen_inactivo']['mini'], array('class' => 'img-responsive')); ?>
	                    		</div>
	                    		<div class="col-xs-12 col-sm-6">
