			...
			<div class="panel panel-default">
				<div class="panel-heading">
					...
					<div class="btn-group pull-right">
						<?= $this->Html->link('<i class="fa fa-plus"></i> Nuevo Slider', array('action' => 'add'), array('class' => 'btn btn-success', 'escape' => false)); ?>
						...
						<table class="table">
							...
							<tbody>
								...
								<tr>
									...
									<td><?= $this->Html->image($banner['Banner']['imagen']['mini'], array('class' => 'img-responsive')); ?>&nbsp;</td>
